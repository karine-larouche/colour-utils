...
describe('Error handling', () => {
  ...
  test('Providing a negative ratio throws a meaningful error', () => {
    const expected =
      'Third argument of "mix" is invalid. Expected number between 0 and 1 (inclusive), but received ';
    expect(() => mix('#000000', '#000000', -0.1)).toThrowError(
      expected + '-0.1',
    );
  });
